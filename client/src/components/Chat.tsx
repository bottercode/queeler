...
const httpLink = new HttpLink({
  uri: 'https://main--enchanting-basbousa-f2b256.netlify.app/graphql'
})

const wsLink = new GraphQLWsLink(
  createClient({
    url: 'ws://https://https://main--enchanting-basbousa-f2b256.netlify.app//graphql/subscription'
  })
)
...
export const Chat = () => {
  ...
  const [myInfo, setMyInfo] = useState<myInfo>({
    ...
    name: 'Anonymous',
    email: '',
    avatar: 'https://fastly.picsum.photos/id/379/536/354.jpg?hmac=I4bs_0ZcfxuA6apwsLHEPAqDxBprHAwMwtdoK8oJCOU',
    exp: 0,
    iat: 0
  })
    ...
    <ApolloProvider client={client}>
      <ChakraProvider>
        <div className='flex bg-[#000000e3]'>
          {chatComp}
          <Chatsidebar myProfile={myInfo} onSelectUserChat={onSelectUser} onSelectRoomChat={onSelectRoom} />
        </div>
      </ChakraProvider>
    </ApolloProvider>
  )
